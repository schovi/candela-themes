// Aurora design invariants, in one place. The single source of the rule
// definitions from docs/design-handover/README.md ("Design rules to preserve").
...
import { normalizeHex, hexToRgb, relativeLuminance, contrastRatio } from './colors.js';
...
const AA_TOKENS = [...SYNTAX_ACCENTS, ...DIAGNOSTICS, 'faint'];

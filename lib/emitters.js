...
function sublimeReadme(themes) {
  return [
    ...
    '',
    // Real-editor, full-window shots — the per-theme gallery below is app-rendered and
    // shows the editor pane only, so it cannot show what Adaptive actually does to the
    // chrome. Sublime is the only surface with these; see docs/screenshots/README.md.

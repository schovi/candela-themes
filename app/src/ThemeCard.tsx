...
export function ThemeCard({ theme, panes, customizeHref, highlightToken, previewFilter, showMeta = true }: { theme: Theme; panes: Set<PaneKey>; customizeHref?: string; highlightToken?: ColorToken; previewFilter?: string; showMeta?: boolean }) {
  return (
    <section id={theme.id} className="theme-card" data-theme-id={theme.id} data-highlight={highlightToken} style={{ ...themeVars(theme), background: 'var(--bg)' }}>
      <div className="card-inner">
        ...
        <div className="theme-judgement" style={previewFilter ? { filter: previewFilter } : undefined}>
          {showMeta && <div className="swatches">
